...
N2D('SmartSliderAbstract', function ($, undefined) {
    ...
    SmartSliderAbstract.prototype.__initSlides = function () {
        ...
        for (var i = 0; i < $slides.length; i++) {
            this.slides.push(new N2Classes.FrontendSliderSlide(this, $slides.eq(i), i));
        }
...
N2D('FrontendComponent', function ($, undefined) {
     ...
     * @memberOf N2Classes
     *
     * @param {FrontendComponentSlideAbstract} slide
     * @param parent
     * @param $layer
     * @param $children
     * @constructor
...
N2D('FrontendComponentSlideAbstract', ['FrontendComponent'], function ($, undefined) {
     ...
     * @memberOf N2Classes
     *
     * @param {SmartSliderAbstract} slider
     * @param {jQuery} $el
     * @constructor
