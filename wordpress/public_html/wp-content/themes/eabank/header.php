    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
          <?php echo do_shortcode( '[contact-form-7 id="999956966" title="Заявка (физ)"]' ); ?>
        </div>
      </div>
    </div>
  </div>
    <div id="modal_calc" class="modal fade">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
          <h4 class="modal-title">Заявка на вклад</h4>
        </div>
        <div class="modal-body">
          <?php echo do_shortcode( '[contact-form-7 id="999958298" title="Заявка (физ) калькулятор"]' ); ?>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="container">
        <div class="wrap">
          ...
          <ul class="switcher list-unstyled list-inline">
            ...
            <li><a href="/juridicheskim-licam/">Бизнесу</a></li>
          </ul> <!-- //.switcher -->
