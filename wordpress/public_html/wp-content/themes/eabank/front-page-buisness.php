<?php
/*
Template Name: Главная Buisness
*/
?>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-5 col-xs-12">
          <div class="wrap">
            <h2>Бизнес платежи прямо в приложении</h2>
            <div class="description-slider">
              <div class="item">
                <p>Удобное мобильное приложение. Счета, платежи, переписка в режиме Online.</p>
              </div> <!-- //.item -->
              <div class="item">
                <p>Быстрые платежи. Контроль расходов. Качественно, безопасно.</p>
              </div> <!-- //.item -->
              <div class="item">
                <p>Приложение всегда под рукой. Платформа для Apple IOS и Andriod.</p>
              </div> <!-- //.item -->
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-3 col-md-pull-3 col-sm-6 col-xs-6">
          ...
          <a href="https://dbo.eab.ru/ibank2/" target="_blank" class="service-item">
            <img src="<?php echo get_template_directory_uri(); ?>/assets/img/service2.png" alt="">
          </a> <!-- //.service-item -->
        </div> <!-- //.col -->
        <div class="col-md-3 col-sm-6 col-xs-6">
          <strong>Банковские карты</strong>
          <a href="/juridicheskim-licam/bankovskie-karty/" class="service-item">
